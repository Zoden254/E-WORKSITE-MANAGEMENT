"""
Django settings for Root_Conf project.
...
SECRET_KEY = 'django-insecure-iy66cqyi&6b^(xu2t#$!2fwyh%x4e#cr%d3t--%8=j-6gs#e7$'
...
WSGI_APPLICATION = 'Root_Conf.wsgi.application'
